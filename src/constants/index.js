...
export const roadmap = [
  {
    ...
    text: "Gained initial users by building free custom MCP servers for early partners, establishing Synapse as a deployable NLP processing service.",
    date: "May 2023",
    status: "done",
    imageUrl: roadmap1,
    colorful: true,
  },
  {
    ...
    text: "Establishing revenue streams through consultancy retainers for custom MCP server development, attracting more integration clients and users.",
    date: "May 2023",
    status: "progress",
    imageUrl: roadmap2,
  },
  {
    ...
    text: "Released preconfigured MCP building blocks (e.g., custody, vault, on-ramp) to enable independent builders to rapidly construct structured products.",
    date: "May 2023",
    status: "done",
    imageUrl: roadmap3,
  },
  ...
  {
    id: "4",
    title: "Data Aggregation & Licensing",
    text: "Collect and analyze user intent data from MCP servers, licensing insights to optimize liquidity and trading strategies.",
    date: "Q4 2024",
    status: "progress",
    imageUrl: roadmap1,
    colorful: true,
  ...
  {
    id: "5",
    title: "Agent Developer Kit (ADK) Launch",
    text: "Extend Synapse's reach to legacy and offline systems by enabling developers to build custom MCP servers for systems without public APIs.",
    date: "Q1 2025",
    status: "progress",
    imageUrl: roadmap2,
  },
